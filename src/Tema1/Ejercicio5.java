...
public class Ejercicio5 {
    public static void main(String[] args) {
        ...
        // 6. 7 >= 5 OR 27 <> 8   (<> en Java es !=)
        System.out.println("6. 7 >= 5 || 27 != 8 = " + (7 >= 5 || 27 != 8));

        // 7. (45 <= 7) OR NOT (5 >= 7)   (NOT en Java es !)
        System.out.println("7. (45 <= 7) || !(5 >= 7) = " + ((45 <= 7) || !(5 >= 7)));

        // 8. 27 % 4 + 15 / 4
        System.out.println("8. 27 % 4 + 15 / 4 = " + (27 % 4 + 15 / 4));

        // 9. 37 / 4 * 4 - 2
        System.out.println("9. 37 / 4 * 4 - 2 = " + (37 / 4 * 4 - 2));

        // 10. (25 >= 7) AND NOT (7 <= 2)
        System.out.println("10. (25 >= 7) && !(7 <= 2) = " + ((25 >= 7) && !(7 <= 2)));

        // 11. ('H' < 'J') AND ('9' <> '7')
        System.out.println("11. ('H' < 'J') && ('9' != '7') = " + (('H' < 'J') && ('9' != '7')));

        // 12. 25 > 20 AND 13 > 5
        System.out.println("12. 25 > 20 && 13 > 5 = " + (25 > 20 && 13 > 5));
